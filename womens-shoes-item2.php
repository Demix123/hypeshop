  ...
  <body>
        ...
        <div class="row">
                    ...
                    <div class="all-photo">
                        <div class="bph">
                            <div class="slider-pro" id="my-slider">
                                <div class="sp-slides">
                                    <div class="sp-slide">
                                        <img class="sp-image womens-shoes-img" src="images/womens-shoes/item2/1.jpg" alt="womens-shoes-item2"/>
                                        <img class="sp-thumbnail" src="images/womens-shoes/item2/1.jpg" alt="womens-shoes-item2-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image womens-shoes-img" src="images/womens-shoes/item2/2.jpg" alt="womens-shoes-item2"/>
                                        <img class="sp-thumbnail" src="images/womens-shoes/item2/2.jpg" alt="womens-shoes-item2-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image womens-shoes-img" src="images/womens-shoes/item2/3.jpg" alt="womens-shoes-item2"/>
                                        <img class="sp-thumbnail" src="images/womens-shoes/item2/3.jpg" alt="womens-shoes-item2-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image womens-shoes-img" src="images/womens-shoes/item2/4.jpg" alt="womens-shoes-item2"/>
                                        <img class="sp-thumbnail" src="images/womens-shoes/item2/4.jpg" alt="womens-shoes-item2-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image womens-shoes-img" src="images/womens-shoes/item2/5.jpg" alt="womens-shoes-item2"/>
                                        <img class="sp-thumbnail" src="images/womens-shoes/item2/5.jpg" alt="womens-shoes-item2-thumb"/>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col info">
                <div class="arrival-container arrival-col">
                    ...
                    <h1 class="model">Adidas Falcon</h1>
    ...
    <div id="modal_form"> 
        ...
        <form method="post">
            ...
            <input type="text"class="form-control" id="post" placeholder="Введіть номер найближчого Нової пошти" name="user-number">
