                    ...
                    <div class="all-photo">
                        <div class="bph">
                            <div class="slider-pro" id="my-slider">
                                <div class="sp-slides">
                                    <div class="sp-slide">
                                        <img class="sp-image" src="images/arrival-1/arrival1-item2.jpg" alt="arrival-1"/>
                                        <img class="sp-thumbnail" src="images/arrival-1/arrival1-item2.jpg" alt="arrival-1-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image" src="images/arrival-1/arrival1-item1.jpg" alt="arrival-1"/>
                                        <img class="sp-thumbnail" src="images/arrival-1/arrival1-item1.jpg" alt="arrival-1-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image" src="images/arrival-1/arrival1-item5.jpg" alt="arrival-1"/>
                                        <img class="sp-thumbnail" src="images/arrival-1/arrival1-item5.jpg" alt="arrival-1-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image" src="images/arrival-1/arrival1-item4.jpg" alt="arrival-1"/>
                                        <img class="sp-thumbnail" src="images/arrival-1/arrival1-item4.jpg" alt="arrival-1-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image" src="images/arrival-1/arrival1-item3.jpg" alt="arrival-1"/>
                                        <img class="sp-thumbnail" src="images/arrival-1/arrival1-item3.jpg" alt="arrival-1-thumb"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="arrival-container arrival-col">
                    ...
                    <div class="btn">
                        <form class="form-inline">
                            ...
                            <button type="submit" class="submit" id="check">Додати в корзину</button>
                        </form>
                    </div>
                    <div class="size">
        ...
        <div class="container arrival-container">
            <div class="more-info">
                ...
                <div class="row">
                    ...
                    <div class="value">Кожа, текстиль</div>
                </div>
                <div class="row">
                ...
                <input type="hidden" value="SenkoDrop, артикул N001">
            </div>
        </div>
    </div>
    <div id="modal_form"> 
