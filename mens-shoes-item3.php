        ...
        <div class="row">
                    ...
                    <div class="all-photo">
                        <div class="bph">
                            <div class="slider-pro" id="my-slider">
                                <div class="sp-slides">
                                    <div class="sp-slide">
                                        <img class="sp-image mens-shoes-img" src="images/mens-shoes/item3/1.jpg" alt="mens-shoes-item3"/>
                                        <img class="sp-thumbnail" src="images/mens-shoes/item3/1.jpg" alt="mens-shoes-item3-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image mens-shoes-img" src="images/mens-shoes/item3/2.jpg" alt="mens-shoes-item3"/>
                                        <img class="sp-thumbnail" src="images/mens-shoes/item3/2.jpg" alt="mens-shoes-item3-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image mens-shoes-img" src="images/mens-shoes/item3/3.jpg" alt="mens-shoes-item3"/>
                                        <img class="sp-thumbnail" src="images/mens-shoes/item3/3.jpg" alt="mens-shoes-item3-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image mens-shoes-img" src="images/mens-shoes/item3/4.jpg" alt="mens-shoes-item3"/>
                                        <img class="sp-thumbnail" src="images/mens-shoes/item3/4.jpg" alt="mens-shoes-item3-thumb"/>
                                    </div>
                                    <div class="sp-slide">
                                        <img class="sp-image mens-shoes-img" src="images/mens-shoes/item3/5.jpg" alt="mens-shoes-item3"/>
                                        <img class="sp-thumbnail" src="images/mens-shoes/item3/5.jpg" alt="mens-shoes-item3-thumb"/>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col info">
                <div class="arrival-container arrival-col">
                    ...
                    <h1 class="model">New Balance 1500</h1>
